<template>
  ...
  >
    <div class="__edit__card">
      <!-- header -->
      <div class="__edit__card__header">
        <h2 class="__edit__card__header__title">Edit Item</h2>
        <button class="__edit__card__header__close" @click="closeModal">
          <span class="material-icons"> close </span>
        </button>
      </div>
      <!-- body -->
      <div class="__edit__card__body">
        <div
          v-if="$store.getters['site/isDesktop']"
          class="__edit__card__body__left"
        >
          <div class="__edit__card__body__item">
          ...
          <div v-show="generatorSettings" class="__edit__card__body__item">
        ...
        <div class="__edit__card__body__right">
          <div class="__edit__card__body__item --split">
            <div class="__edit__card__body__item --split --left">
            ...
            <div class="__edit__card__body__item --split --right">
          ...
          <div class="__edit__card__body__item">
            ...
            <input id="url" v-model="url" type="text" placeholder="http://" />
          </div>
          <div class="__edit__card__body__item">
      ...
      <!-- footer -->
      <div class="__edit__card__footer">
        <button
          class="__edit__card__footer__button --reset"
        ...
        <button
          class="__edit__card__footer__button --save"
          @click.prevent="commitEdit"
        >
...
import GeneratorPanel from '../CreateModal/GeneratorPanel.vue'
...
export default {
  ...
  computed: {
    isOpen() {
      return this.$store.getters['modal/edit']
    },
    formData() {
      const data = {
        uuid: this.uuid,
  ...
  methods: {
    ...
    commitEdit() {
      this.$store.dispatch('vault/updateVaultItem', {
    ...
    resetForm() {
      ...
      this.categorySelect = this.itemData.category
      this.username = this.itemData.username
      this.password = this.itemData.password
      this.url = this.itemData.url
      this.notes = this.itemData.notes
      this.validateForm()
    },
  },
}
